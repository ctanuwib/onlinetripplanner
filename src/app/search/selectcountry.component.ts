...
@Component({
  selector: "SelectCountryComponent",
  template: `
  <mat-form-field>
  <mat-label>Select the Country</mat-label>
  <input type="text" matInput [formControl]="myControl" [(ngModel)]="selectedCountry" [matAutocomplete]="auto">
  </mat-form-field>

  <br>
  <button mat-raised-button (click) = onClick(selectedCountry)>Confirm Country Selection</button>
...
export class SelectCountryComponent implements OnInit {
  ...
  onClick(selectedCountry) {
    this.setCountry.emit(this.selectedCountry);
  }

  invokeEvent(place: Object) {
    this.setCountry.emit(place);
  }
